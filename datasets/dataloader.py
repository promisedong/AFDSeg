...
#         return new_image,img,T_mask,(modify_png,modify_png,modify_png),\
#                (heat2,heat4),((boundary1,boundary2),boundary4,boundary8,boundary16)
#
#     def __getitem__(self, idx):
#         ind1 = idx % len(self.train)
#
#         imagename = self.train[ind1]
#         maskname = imagename
#
#
#         path = r'D:\desktop\Coding process\MedicalData'
#         imagename = os.path.join(path,'images',imagename)
#         imagename = imagename.replace('\\','/')
#         maskname = os.path.join(path,'labels',maskname)
...
#         imagename2 = self.train[ ind2 ]
#         maskname2 = imagename2
#
#
#         imagename2 = os.path.join(path,'images',imagename2)
#         maskname2 = os.path.join(path,'masks_rgb',maskname2)
#         imagename2 = imagename2.replace('\\','/')
#
#         maskname2 = maskname2.replace('\\','/')
#
...
#  def gt():
#     data = BuildDataset(train_file = '../ACDC_train.txt',augment = False)
